...
class Moderation(commands.Cog):
    ...
    async def kick_cmd(self, ctx: commands.Context, member: discord.Member, *, reason: str | None = None) -> None:
        """Kick a member from the server with a prefixed command."""
    ...
    async def ban_cmd(self, ctx: commands.Context, member: discord.Member, *, reason: str | None = None) -> None:
        """Ban a member from the server with a prefixed command."""
